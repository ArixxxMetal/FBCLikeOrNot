...
var app = angular.module("QuestionDevicesGraphApp", []);

app.controller("QuestionDevicesGraphController", function ($scope, $http) {
    ...
    function GetTotalReactionListByDate(start, end) {
        ...
        if ($scope.device_id_model) {
            ...
            Data = {
                PARAM_DEVICE_ID: $scope.device_id_model,
            ...
            $http({
                method: "POST",
                url: "/Reaction/GetQuestionsByDeviceGraph",
